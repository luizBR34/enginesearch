...
public class RetailPrice__1 implements Serializable
{
    ...
    private final static long serialVersionUID = -8347106284313786553L;
    ...
    public String toString() {
        ...
        sb.append(RetailPrice__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetailPrice__1) == false) {
            return false;
        }
        RetailPrice__1 rhs = ((RetailPrice__1) other);
