...
public class GoogleBookAPI implements Serializable
{
    ...
    private final static long serialVersionUID = -2211738241865776069L;
    ...
    public String toString() {
        ...
        sb.append(GoogleBookAPI.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kind");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GoogleBookAPI) == false) {
            return false;
        }
        GoogleBookAPI rhs = ((GoogleBookAPI) other);
